namespace MusicLibForms
{
	partial class TopComposers
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "TopComposers";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "TopComposers";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.TopComposers_FormClosing);
			this.Load += new System.EventHandler(this.TopComposers_Load);
